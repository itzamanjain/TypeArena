  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black  flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">About TypeArena</h1>
        <div className="space-y-6 text-gray-600 dark:text-gray-200">
          ...
          <p>
            Founded in Oct 2024, TypeArena has quickly grown to become a favorite among typing enthusiasts, students, and professionals looking to enhance their keyboard proficiency. Our team of dedicated developers and typing experts work tirelessly to create new challenges, improve user experience, and foster a supportive community.
          </p>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">Our Features</h2>
