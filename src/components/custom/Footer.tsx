...
export function Footer() {
  return (
    <footer className="bg-gray-100 border  text-gray-600 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h4 className="text-2xl font-bold text-gray-900 mb-4">TypeArena</h4>
            <p>Empowering typists worldwide to achieve their full potential.</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h5 className="text-xl font-semibold text-gray-900 mb-4">Quick Links</h5>
          ...
          <div className="w-full md:w-1/3">
            <h5 className="text-xl font-semibold text-gray-900 mb-4">Connect With Us</h5>
